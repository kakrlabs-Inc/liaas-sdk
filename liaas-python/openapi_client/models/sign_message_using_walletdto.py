...
class SignMessageUsingWalletdto(BaseModel):
    """
    SignMessageUsingWalletdto
    """ # noqa: E501
    message: Annotated[str, Field(min_length=1, strict=True)]
    passphrase: Annotated[str, Field(min_length=1, strict=True)]
    address: Annotated[str, Field(min_length=1, strict=True)]
    __properties: ClassVar[List[str]] = ["message", "passphrase", "address"]
