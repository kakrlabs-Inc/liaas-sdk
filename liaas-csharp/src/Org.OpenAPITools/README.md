...
inputSpec: https://liaas-sdk-919521117286.europe-west1.run.app/swagger/v1/swagger.json
outputDir: out

# https://openapi-generator.tech/docs/generators/csharp
additionalProperties:
  packageGuid: '{68315553-0341-4E32-9FD3-3B3BA3DB3B83}'
...
namespace YourProject
{
    public class Program
    {
        public static async Task Main(string[] args)
        {
            ...
            IApiAddressAddressBalanceGetApiResponse apiResponse = await api.ApiAddressAddressBalanceGetAsync("todo");
