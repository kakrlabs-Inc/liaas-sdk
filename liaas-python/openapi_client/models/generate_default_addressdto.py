...
class GenerateDefaultAddressdto(BaseModel):
    """
    GenerateDefaultAddressdto
    """ # noqa: E501
    address_type: Optional[StrictInt] = Field(default=None, alias="addressType")
    label: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["addressType", "label"]
