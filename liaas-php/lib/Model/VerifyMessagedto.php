...
/**
 * VerifyMessagedto Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class VerifyMessagedto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'VerifyMessagedto';
    ...
    */
    ...
    public function setAddress($address)
    {
        ...
        if ((mb_strlen($address) < 1)) {
            throw new \InvalidArgumentException('invalid length for $address when calling VerifyMessagedto., must be bigger than or equal to 1.');
        }
    ...
    public function setMessage($message)
    {
        ...
        if ((mb_strlen($message) < 1)) {
            throw new \InvalidArgumentException('invalid length for $message when calling VerifyMessagedto., must be bigger than or equal to 1.');
        }
    ...
    public function setSignature($signature)
    {
        ...
        if ((mb_strlen($signature) < 1)) {
            throw new \InvalidArgumentException('invalid length for $signature when calling VerifyMessagedto., must be bigger than or equal to 1.');
        }
