...
/**
 * CreateRawTransactiondto Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CreateRawTransactiondto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateRawTransactiondto';
    ...
    */
    ...
    public function setRecipientAddress($recipient_address)
    {
        ...
        if ((mb_strlen($recipient_address) < 1)) {
            throw new \InvalidArgumentException('invalid length for $recipient_address when calling CreateRawTransactiondto., must be bigger than or equal to 1.');
        }
    ...
    public function setSenderAddress($sender_address)
    {
        ...
        if ((mb_strlen($sender_address) < 1)) {
            throw new \InvalidArgumentException('invalid length for $sender_address when calling CreateRawTransactiondto., must be bigger than or equal to 1.');
        }
