...
/**
 * EncryptWalletDto Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class EncryptWalletDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EncryptWalletDto';
    ...
    */
    ...
    public function setPassphrase($passphrase)
    {
        ...
        if ((mb_strlen($passphrase) < 1)) {
            throw new \InvalidArgumentException('invalid length for $passphrase when calling EncryptWalletDto., must be bigger than or equal to 1.');
        }
