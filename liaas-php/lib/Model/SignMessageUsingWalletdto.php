...
/**
 * SignMessageUsingWalletdto Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class SignMessageUsingWalletdto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'signMessageUsingWalletdto';
    ...
    */
    ...
    public function setMessage($message)
    {
        ...
        if ((mb_strlen($message) < 1)) {
            throw new \InvalidArgumentException('invalid length for $message when calling SignMessageUsingWalletdto., must be bigger than or equal to 1.');
        }
    ...
    public function setPassphrase($passphrase)
    {
        ...
        if ((mb_strlen($passphrase) < 1)) {
            throw new \InvalidArgumentException('invalid length for $passphrase when calling SignMessageUsingWalletdto., must be bigger than or equal to 1.');
        }
    ...
    public function setAddress($address)
    {
        ...
        if ((mb_strlen($address) < 1)) {
            throw new \InvalidArgumentException('invalid length for $address when calling SignMessageUsingWalletdto., must be bigger than or equal to 1.');
        }
